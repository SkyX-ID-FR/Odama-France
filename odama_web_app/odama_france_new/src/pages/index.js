      ...
      <section id="right_content_page">
        ...
        <div className='calendar_box'>
          <div className='selector'>
            ...
            <div id="item_2" className='item'><h1>10</h1><p>Février</p><div className='circle'></div></div>
            <div id="item_3" className='item active_item'><h1>13</h1><p>Février</p><div className='circle'></div></div>
            <div id="item_4" className='item'><h1>16</h1><p>Février</p><div className='circle'></div></div>
            <div id="item_5" className='item'><h1>01</h1><p>Mars</p><div className='circle'></div></div>
          </div>
          ...
          <div id="event_box_2">
            <div className='event_item'>
              <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bookmark"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>
              <span>#movies · Le Vendredi 10 Février 2023</span>
          ...
          <div id="event_box_4">
            <div className='event_item'>
              <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bookmark"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>
              <span>#series · Le Jeudi 16 Février 2023</span>
